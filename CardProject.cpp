...
stack <float> main_deck;    //Using a global stack so we can push our array of cards into the stack
...
void shuffle() //Deck Shuffling Function
{
...
int main()
{
	...
	cout << "To draw a card, press enter" << endl;
	...
	cout << "Please enter the number of players for this game and click enter: \n";
	cin >> players;
	getchar();
	...
	{
		system("cls"); //Clears the console to look nicer each round.
		cout << endl;
		for (int i = 0; i < players; i++)
		{

			//round 1 starts and first person picks card
			//Press a button to pick a card and click enter

				cout << "Player" << i + 1 << " click enter to pick a card." << endl;
				getchar();
		...
		else if (max == pickedcards[0])
		{
			...
			cout << endl;
			if ((scores[0] >= 21) && (scores[0] - scores[2] >= 2) && (scores[0] - scores[3] >= 2) && (scores[0] - scores[1] >= 2))
			{
				cout << endl;
		...
		else if (max == pickedcards[1])
		{
			...
			cout << endl;
			if ((scores[1] >= 21) && (scores[1] - scores[2] >= 2) && (scores[1] - scores[3] >= 2) && (scores[1] - scores[0] >= 2))
			{
				cout << endl;
		...
		else if (max == pickedcards[2])
		{
			...
			cout << endl;
			if ((scores[2] >= 21) && (scores[2] - scores[3] >= 2) && (scores[2] - scores[1] >= 2) && (scores[2] - scores[0] >= 2))
			{
				cout << endl;
		...
		else if (max == pickedcards[3])
		{
			...
			cout << endl;
			if ((scores[3] >= 21) && (scores[3] - scores[2] >= 2) && (scores[3] - scores[1] >= 2) && (scores[3] - scores[0] >= 2))
			{
				cout << endl;
		...
		while (main_deck.empty() == false)
		{
			main_deck.pop();
		}
		shuffle();  //Shuffles after each round.

	}
	int x;   //press an integer and enter to exit
	cin >> x; 
}
